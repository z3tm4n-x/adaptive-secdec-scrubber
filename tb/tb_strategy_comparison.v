...
adaptive_scrub_controller #(
    ...
    .MEASURED_WINDOW_CYCLES(MEASURED_WINDOW_CYCLES),
    .MEASURED_CORRECTED_WEIGHT(MEASURED_CORRECTED_WEIGHT),
    .MEASURED_UNCORRECTABLE_WEIGHT(MEASURED_UNCORRECTABLE_WEIGHT),
    .MEASURED_THRESHOLD_LEVEL1(MEASURED_THRESHOLD_LEVEL1),
    .MEASURED_THRESHOLD_LEVEL2(MEASURED_THRESHOLD_LEVEL2),
    .MEASURED_THRESHOLD_LEVEL3(MEASURED_THRESHOLD_LEVEL3),
    .MEASURED_THRESHOLD_LEVEL4(MEASURED_THRESHOLD_LEVEL4),
    .MEASURED_THRESHOLD_LEVEL5(MEASURED_THRESHOLD_LEVEL5),
    .MEASURED_THRESHOLD_LEVEL6(MEASURED_THRESHOLD_LEVEL6),
    .MEASURED_THRESHOLD_LEVEL7(MEASURED_THRESHOLD_LEVEL7)
) controller_inst (
    .clk(clk),
    .rst(rst),
    .enable(enable),
