...
## 4. Observable signal и measured-control
...
Важно: measured-control здесь является offline replay:
...
- measured-control реализован как offline replay, а не как полностью замкнутый RTL-контур;
