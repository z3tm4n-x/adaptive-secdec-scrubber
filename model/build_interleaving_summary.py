...
def add_deltas_section(lines: list[str], deltas: list[dict[str, object]]) -> None:
    ...
    lines.append(
        ...
        "Внутри D=3 на более медленных интервалах появляются отдельные unique DUE, "
        "что качественно соответствует возврату к накопительной, управляемой интервалом модели риска; "
        "однако в данной серии paired-delta CI для slowest-fastest по unique включает ноль, "
